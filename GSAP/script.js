...
// gsap.from('.footer', {duration: 1, y:0, ease: 'elastic', delay: 2.5 })

// gsap.from( '.button', {opacity: 0, scale: 0, rotation: 720}, {duration: 1, delay: 3.5, opacity: 1, scale: 1, rotation: 0} )
...
timeline
  ...
  .from('.left', {delay: 2, x: '-100%'}, '<.5')
  .to('.footer', {y:0, ease: 'elastic'})
  .from( '.button', {opacity: 0, scale: 0, rotation: 720}, {opacity: 1, scale: 1, rotation: 0} )
